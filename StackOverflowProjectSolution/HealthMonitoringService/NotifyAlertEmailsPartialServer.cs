...
{
    public class NotifyAlertEmailsPartialServer
    {
        private ServiceHost serviceHost;
        // dodati endpoint sa ovim imenom u ServiceDefinition
        private String externalEndpointName = "SendAlertEmails";
        public NotifyAlertEmailsPartialServer()
        {
            ...
            serviceHost = new ServiceHost(typeof(NotifyAlertEmailsProvider));
            NetTcpBinding binding = new NetTcpBinding();
            serviceHost.AddServiceEndpoint(typeof(INotifyAlertEmails), binding, endpoint);
        }
        public void Open()
        {
            try
